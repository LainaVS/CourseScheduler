...
def schedule_generator():
    ...
    return render_template('index.html',
                            free_elective_credits_accumulated=render_info["free_elective_credits_accumulated"],
                            TOTAL_CREDITS_FOR_GEN_EDS=render_info["TOTAL_CREDITS_FOR_GEN_EDS"],
                            accumulated_gen_eds=render_info["accumulated_gen_eds"],
                            TOTAL_CREDITS_FOR_CERTIFICATE_ELECTIVES=render_info["TOTAL_CREDITS_FOR_CERTIFICATE_ELECTIVES"],
                            accumulated_certificates=render_info["accumulated_certificates"],
                            ADJUSTED_TOTAL_FOR_3000=render_info["ADJUSTED_TOTAL_FOR_3000"],
                            adjusted_accumulated_3000=render_info["accumulated_3000"],
